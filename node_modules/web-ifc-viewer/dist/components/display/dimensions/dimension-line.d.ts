...
export declare class IfcDimensionLine {
    ...
    private endpointMaterial;
    private boundingMesh?;
    private readonly boundingSize;
    constructor(context: Context, start: Vector3, end: Vector3, lineMaterial: LineBasicMaterial, endpointMaterial: MeshBasicMaterial, endpointGeometry: BufferGeometry, className: string, endpointScale: Vector3);
