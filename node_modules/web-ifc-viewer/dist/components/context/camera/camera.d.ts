import { Camera, Mesh, OrthographicCamera, PerspectiveCamera } from 'three';
import CameraControls from 'camera-controls';
import { CameraProjections, Context, IfcComponent, NavigationMode, NavigationModes, NavModeManager } from '../../../base-types';
